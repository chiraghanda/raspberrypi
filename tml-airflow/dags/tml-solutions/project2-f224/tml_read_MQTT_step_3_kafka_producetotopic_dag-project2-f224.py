...
default_args = {
  ...
  'mqtt_broker' : '5e8552f848094ede9685d93a0c082361.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_project2-f224", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_project2-f224"], schedule=None,catchup=False)
