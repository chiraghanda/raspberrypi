...
default_args = {
 ...
 'solutionname': 'myfirsttssproject3-98fa',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_myfirsttssproject3-98fa", default_args=default_args, tags=["tml_system_step_1_getparams_dag_myfirsttssproject3-98fa"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
